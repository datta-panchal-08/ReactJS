...
const RecipeCard = ({ recipe }) => {
  ...
  return (
    recipe && (
      <Link to={`/recipe/detail/${recipe.id}`} className="w-[28%] px-2 py-2 shadow-lg relative shadow-black mt-10 h-fit bg-white rounded-xl text-black">
        ...
        <div className="title flex flex-col gap-2">
          <h4 className="w-[55%] text-nowrap tracking-tight leading-4 font-semibold">
            {recipe?.title}
          </h4>
